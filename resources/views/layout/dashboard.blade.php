                                                ...
                                                <tbody>
                                                    @foreach ($demande as $item)
                                                        <tr>
                                                            ...
                                                            <td><span
                                                                    class="text-primary">{{ ucfirst($item->type) }}</span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>{{ $item->datedeb }}</td>
                                                            <td>{{ $item->datefin }}</td>
                                                            <td><span class="badge bg-danger">{{ $item->status }}</span>
                                                            </td>
                                                            @if ($item->status == 'Non Approuvée')
                                                                <td><a class="btn btn-outline-info btn-sm" href="{{ url('editdemandes/' . $item->id) }}">Modifier</a></td>
                                                            @endif
                                                        </tr>
                                                    @endforeach
                                                </tbody>
